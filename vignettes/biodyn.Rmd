...
```{runcertaintyBoot, fig.height=4, fig.margin=TRUE, fig.cap="Bootstrapped CPUE series",eval=FALSE}
...
```{runcertaintySave,eval=FALSE,echo=FALSE}
...
```{rrefBmsy,fig.fullwidth=TRUE, fig.width=4, fig.height=6,fig.cap="Densities of Stock from different methods for estimating uncertainty.",eval=FALSE}
